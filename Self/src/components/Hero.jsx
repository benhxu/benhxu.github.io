import { SFCanvas } from ".";
import Position from "./Position";

const Hero = ({ scrollContainer }) => {
  return (
    <section className="parallax">
      <div className='parallax__content absolute top-[5%] sm:top-[10%] lg:top-[10%] w-full mx-auto lg:pl-[38vh] lg:pr-[30vh] xl:pl-96 xl:pr-72 2xl:px-40 3xl:px-60 flex flex-col lg:flex-row items-start z-10'>
        ...
        <div className="flex-1 flex justify-start lg:justify-space-between mt-4 sm:mt-14 ml-8 xs:ml-[-4vh] sm:ml-[-17vh] md:ml-[-26vh] lg:mt-10 2xl:mt-0">
      ...
      <img className="hero_bg" src="./parallax/1Stars.svg" alt="" />
      ...
      <SFCanvas scrollContainer={scrollContainer} />
    </section>
  );
};
